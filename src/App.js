...
if (editLeavePinInput !== "2391") {
  closeEditLeaveModal();

  setTimeout(() => {
    showToast(
      "Incorrect PIN. No changes were made to the leave record.",
      "error"
    );
  }, 120);
    ...
    >
      ...
      <label className="handover-modal-label">
        ...
        <input
          ...
          value={editLeavePinInput}
          onChange={(e) => setEditLeavePinInput(e.target.value)}
        />
      </label>
...
{buildInfoOpen && (
  ...
  >
    ...
    >
      ...
      <div className="build-info-summary">
        <strong>10</strong>
        <span>Recent improvements added to the system</span>
      </div>

      <div className="build-upgrade-list">
        {recentBuildUpgrades.map((upgrade, index) => (
          <div className="build-upgrade-item" key={upgrade.title}>
            <span className="build-upgrade-number">
